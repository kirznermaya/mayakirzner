    ...
    public void onConnectClick(View view) {
        ...
        signalRService.connect(finalIp, new SignalRService.Listener() {
            ...
            public void onConnected() {
                runOnUiThread(() -> Toast.makeText(Main2Activity.this, "Connected to hub", Toast.LENGTH_SHORT).show());
            }

            @Override
            public void onDisconnected(Throwable error) {
                runOnUiThread(() -> Toast.makeText(Main2Activity.this, "Hub error: " + (error != null ? error.getMessage() : "unknown"), Toast.LENGTH_LONG).show());
            }
